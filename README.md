...
## Weather Data
The wetaher data isd generated by using a python librbary that fetches the weather data in a certain date range and then is converted to a csv file. The date range of the script that fetches the feather data can be modifiied. Furthermore the location of the weather data information can be changed, in thsi case Chicago is the city we get the wetaher data from. 
